...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../../../cache/phpthumb/';                            // set the cache directory relative to the phpThumb() installation
...
//$PHPTHUMB_CONFIG['high_security_password']   = 'anypasswordhere';     // required if 'high_security_enabled' is true, must be at least 5 characters long
